...
<head>
    ...
    <!-- Custom CSS -->
    <link href="{{ URL::asset('/asset/css/sb-admin.css') }}" rel="stylesheet">

     <!-- Morris CSS -->
    <link href="{{ URL::asset('/asset/css/plugins/morris.css') }}" rel="stylesheet">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="charts.html"><i class="glyphicon glyphicon-plus"></i> Charts</a>
                    </li>
                    <li>
